...
LEMON_SQUEEZY_PRODUCT_ID = os.getenv("LEMON_SQUEEZY_PRODUCT_ID", "LINGO").strip()
LEMON_SQUEEZY_VARIANT_ID = os.getenv("LEMON_SQUEEZY_VARIANT_ID", "").strip()
TRANSLATION_MODEL = os.getenv("TRANSLATION_MODEL", os.getenv("GROQ_MODEL", "openai/gpt-oss-120b"))
TRANSLATION_PROMPT_VERSION = os.getenv("TRANSLATION_PROMPT_VERSION", "v1").strip() or "v1"
PRODUCT_ID = os.getenv("PRODUCT_ID", "LINGO").strip()
FIRST_MONTH_FREE = os.getenv("FIRST_MONTH_FREE", "true").strip().lower() in {"1", "true", "yes"}

CHROMIUM_EXTENSION_ORIGIN = r"^chrome-extension://[a-z]{32}$"
MAX_BODY_BYTES = 16_384
MAX_TEXT_CHARS = 4_000
MAX_GROQ_RESPONSE_CHARS = 8_000
...
RATE_LIMIT_TRANSLATE_PER_MINUTE = _int_env(
...
def resolve_cors_origins(
    ...
    if app_env == "production":
        return ["https://lingo.zaixos.com", "https://lingo-api.zaixos.com"]
    return []
